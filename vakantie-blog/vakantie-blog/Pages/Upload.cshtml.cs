...
namespace vakantie_blog.Pages
{
    public class UploadModel : PageModel
    {
        ...
        [BindProperty]
        [Required(ErrorMessage = "The Locatie field is required.")]
                ...
                try
                {
                    using (var connection = new SqliteConnection($"Data Source={_dbPath}"))
                    {
                        ...
                        foreach (var file in UploadedFiles)
                        {
                            ...
                            insertCommand.CommandText = "INSERT INTO Files (FileName, FilePath, UploadedBy, Locatie) VALUES (@FileName, @FilePath, @UploadedBy, @Locatie)";
